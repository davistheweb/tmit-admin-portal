...
export const Applications: React.FC = () => {
  return (
    <div className="min-h-screen bg-gray-100 dark:bg-gray-800 p-4 text-gray-900 dark:text-gray-100">
      ...
      {/* Table container with horizontal scroll only on table area */}
      <div className="w-full">
        <div className="overflow-x-auto">
          <div className="inline-block min-w-max">
            <table className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-lg">
